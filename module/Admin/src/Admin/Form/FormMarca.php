...
class FormMarca extends Form
{
    ...
    {
        parent::__construct("frmmarca");
        $this->basePath = $basePath;
        $this->setAttributes(array(
            'action' => $this->basePath.'/admin/marca/index',
            'method' => 'post',
    ...
    private function generarCampos()
    {
        ...
        $this->add(array(
                ...
                'attributes'=>array(
                        ...
                        'value'=>'Eliminar',
                        'title'=>'Eliminar',
                        'onClick'=>"$(location).attr('href','".$this->basePath."/admin/marca/eliminar?id='+$('#idMarca').val());",
                        'style'=>'margin:2px',
