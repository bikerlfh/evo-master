...
class FormPais extends Form
{
    ...
    {
        parent::__construct("frmpais");
        $this->basePath = $basePath;
        $this->setAttributes(array(
            'action' => $this->basePath.'/admin/pais/index',
            'method' => 'post',
    ...
    private function generarCampos()
    {
        ...
        $this->add(array(
                ...
                'attributes'=>array(
                        ...
                        'value'=>'Eliminar',
                        'title'=>'Eliminar',
                        'onClick'=>"$(location).attr('href','".$this->basePath."/admin/pais/eliminar?id='+$('#idPais').val());",
                        'style'=>'margin:2px',
