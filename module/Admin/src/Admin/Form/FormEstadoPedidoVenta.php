...
class FormEstadoPedidoVenta extends Form
{
    ...
    {
        parent::__construct("frmestadopedidoventa");
        $this->basePath = $basePath;
        $this->setAttributes(array(
            'action' => $this->basePath.'/admin/estadopedidoventa/index',
            'method' => 'post',
    ...
    {
        $this->add(array(
            'name' => 'idEstadoPedidoVenta',                       
            'attributes' => array(
                'id'=>'idEstadoPedidoVenta', 
                'type' => 'hidden',
            ),
        ));
        ...
        $this->add(array(
                ...
                'attributes'=>array(
                        ...
                        'value'=>'Eliminar',
                        'title'=>'Eliminar',
                        'onClick'=>"$(location).attr('href','".$this->basePath."/admin/estadopedidoventa/eliminar?id='+$('#idEstadoPedidoVenta').val());",
                        'style'=>'margin:2px',
